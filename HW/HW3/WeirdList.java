...
public class WeirdList {
    ...
    public int length() {
        WeirdList temp = this;
        return 1 + temp._tail.length();  // TODO: REPLACE THIS LINE
    }
    ...
    private static class EmptyWiredList extends WeirdList {
        public EmptyWiredList(int head, WeirdList tail) {
            super(head, tail);
        }
        public int length() {
            return 0;
