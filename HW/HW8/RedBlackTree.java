...
public class RedBlackTree<T extends Comparable<T>> {
    ...
    RBTreeNode<T> buildRedBlackTree(BTree.Node<T> r) {
        ...
        if (r.getItemCount() == 3) {
            RBTreeNode re = new RBTreeNode(true, r.getChildAt(1));
            re.left = new RBTreeNode(false, r.getChildAt(0));
            re.right = new RBTreeNode(false, r.getChildAt(2));
            ...
            return re;
        } else if (r.getChildrenCount() == 2) {
            RBTreeNode re = new RBTreeNode(true, r.getChildAt(0));
            re.right = new RBTreeNode(false, r.getChildAt(1));
            if(!(r.getChildrenCount() == 0)) {
    ...
    RBTreeNode<T> rotateRight(RBTreeNode<T> node) {
        // YOUR CODE HERE
        RBTreeNode rR = new RBTreeNode(false, node.item, node.left.right, node.right);
        return new RBTreeNode<T>(node.isBlack, node.left.item, node.left.left, rR);
    }
    ...
    RBTreeNode<T> rotateLeft(RBTreeNode<T> node) {
        // YOUR CODE HERE
        RBTreeNode rL = new RBTreeNode<T>(false, node.item, node.left, node.right.left);
        return new RBTreeNode<T>(node.isBlack, node.right.item, rL, node.right.right);
    }
